...
export const HeroSection = ({ personalInfo, navigationItems }) => {
  return (
    <section
      ...
      className="w-full pt-24 md:pt-32 pb-8 md:pb-16"
    >
      <div className="max-w-screen-2xl mx-auto px-4 sm:px-8 md:px-16 lg:px-[120px]">
        <div className="flex flex-col items-center justify-center gap-8 md:gap-16">
          ...
          <div className="flex flex-col w-full items-center gap-8 md:gap-16 relative flex-[0_0_auto]">
            ...
            >
              ...
              <div
                className="inline-flex flex-col items-center sm:items-start justify-center gap-4 sm:gap-8 relative flex-[0_0_auto]"
                data-aos="zoom-in"
                data-aos-delay="400"
              >
                <Image
            ...
            {/* Main Content */}
            <div
              className="flex flex-col items-center gap-8 sm:gap-12 relative self-stretch w-full flex-[0_0_auto]"
              data-aos="fade-up"
              data-aos-delay="600"
            >
