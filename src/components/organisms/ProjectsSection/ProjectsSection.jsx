...
export const ProjectsSection = ({ projects }) => {
  return (
    <section
      id="projects"
      className="flex flex-col items-center gap-8 sm:gap-12 md:gap-16 px-4 sm:px-8 md:px-16 lg:px-[120px] py-8 relative self-stretch w-full"
    >
      <div className="flex flex-col items-center gap-6 sm:gap-8 relative self-stretch w-full">
        ...
        <Text
          ...
          color="secondary"
          align="center"
          className="w-full max-w-[782px] px-4"
        >
